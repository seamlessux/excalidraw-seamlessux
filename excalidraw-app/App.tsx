...
import { observeExcalidrawState, observeShareDialog } from "./vibecheck";
...
const ExcalidrawWrapper = () => {
  ...
  // VibeCheck demo instrumentation: the share dialog is a detour for users who want an image.
  useEffect(() => {
    observeShareDialog(shareDialogState.isOpen, isCollaborating);
  ...
  const onChange = (
    ...
    // VibeCheck demo instrumentation (semantic events only; see ./vibecheck.ts)
    observeExcalidrawState(elements, appState);
    if (collabAPI?.isCollaborating()) {
