...
class App extends React.Component<AppProps, AppState> {
  ...
  public onExportImage = async (
    ...
    // VibeCheck demo instrumentation: client-observed export outcome (labeled demo modification).
    (window as unknown as { vibecheckExport?: (t: string) => void }).vibecheckExport?.(type);
